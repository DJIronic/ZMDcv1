...
public class Process {
    ...
    public void quantizeImage(int blockSize, double quality, Boolean inverse ){
        if(inverse){
            modifiedY = Quantization.inverseQ(modifiedY, blockSize, quality, true);
            modifiedCb = Quantization.inverseQ(modifiedCb, blockSize, quality, false);
            modifiedCr = Quantization.inverseQ(modifiedCr, blockSize, quality, false);
        }
        else{
