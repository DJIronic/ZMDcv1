...
public class Quantization {
    ...
    public static Matrix inverseQ(Matrix input, int blockSize, double quality, boolean matrixY) {
        Matrix quantizationMatrix = getQuantizationMatrix(blockSize, quality, matrixY);
    ...
    public static Matrix getQuantizationMatrix (int blockSize, double quality, boolean matrixY) {
        ...
        Matrix resultMatrix;
        if (matrixY) {
            resultMatrix = matrixyV;
        } else {
            resultMatrix = matrixV;
        }
        if (blockSize < 8) {
    ...
    public static Matrix matrixV = new Matrix(8,8).constructWithCopy(quantizationMatrix8C);
    public static Matrix matrixyV = new Matrix(8,8).constructWithCopy(quantizationMatrix8Y);
}
